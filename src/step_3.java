...
public class step_3 {
	...
	//B' 동작 //가장 뒷 부분을 오른쪽 방향으로 회전
	public static void bMoveRight (char frontArr[][],char backArr[][],char rightArr[][],char leftArr[][],char topArr[][],char bottomArr[][]) {
		char[] tmpTop = {topArr[0][0],topArr[0][1],topArr[0][2]};
		char[][] tmpBack = {{backArr[0][0], backArr[0][1], backArr[0][2]},
				 			{backArr[1][0], backArr[1][1], backArr[1][2]},
				 			{backArr[2][0], backArr[2][1], backArr[2][2]}};
		...
		for(int i=0 ; i<3 ; i++) {
			//top,left,bottom,right 큐브 단면이 회전됨
			topArr[0][i] = leftArr[2-i][0];
			leftArr[2-i][0] = bottomArr[0][2-i];
			bottomArr[0][2-i] = rightArr[i][2];
			rightArr[i][2] = tmpTop[i];
			
			//back 큐브 단면이 회전됨
			backArr[i][0] = tmpBack[2][i];
			backArr[i][1] = tmpBack[1][i];
			backArr[i][2] = tmpBack[0][i];
		}
	}
	...
	//R' 동작 //가장 오른쪽 부분을 아래쪽 방향으로 회전
	public static void rMoveDown (char frontArr[][],char backArr[][],char rightArr[][],char leftArr[][],char topArr[][],char bottomArr[][]) {
		char[] tmpFront = {frontArr[0][2],frontArr[1][2],frontArr[2][2]};
		char[][] tmpRight = {{rightArr[0][0], rightArr[0][1], rightArr[0][2]},
							 {rightArr[1][0], rightArr[1][1], rightArr[1][2]},
							 {rightArr[2][0], rightArr[2][1], rightArr[2][2]}};
		for(int i=0 ; i<3 ; i++) {
			...
			frontArr[i][2] = topArr[i][2];
			topArr[i][2] = backArr[2-i][2];
			backArr[2-i][2] = bottomArr[2-i][2];
			bottomArr[2-i][2] = tmpFront[i];
			
			//right 큐브 단면이 회전됨
			rightArr[2-i][0] = tmpRight[0][i];
			rightArr[2-i][1] = tmpRight[1][i];
			rightArr[2-i][2] = tmpRight[2][i];
		}
	}
	...
	//L' 동작 //가장 왼쪽 부분을 위쪽 방향으로 회전
	public static void lMoveUp (char frontArr[][],char backArr[][],char rightArr[][],char leftArr[][],char topArr[][],char bottomArr[][]) {
		char[] tmpFront = {frontArr[0][0],frontArr[1][0],frontArr[2][0]};
		char[][] tmpLeft = {{leftArr[0][0], leftArr[0][1], leftArr[0][2]},
	 						{leftArr[1][0], leftArr[1][1], leftArr[1][2]},
	 						{leftArr[2][0], leftArr[2][1], leftArr[2][2]}};
		...
		for(int i=0 ; i<3; i++) {
			//front,bottom,back,top 큐브 단면이 회전됨
			frontArr[i][0] = bottomArr[2-i][0];
			bottomArr[2-i][0] = backArr[2-i][0];
			backArr[2-i][0] = topArr[i][0];
			topArr[i][0] = tmpFront[i];
			
			//left 큐브 단면이 회전됨
			leftArr[2-i][0] = tmpLeft[0][i];
